...
test("V2.1 artwork, wallet-first composition and stable decorative identities", async ({ page }, info) => {
  ...
  await expect(page.locator(".today-rail > section").first()).toHaveClass("account-panel");
