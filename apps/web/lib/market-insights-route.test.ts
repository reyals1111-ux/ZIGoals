...
it('never reuses cached RWA evidence under a conflicting asset type',async()=>{
 ...
 const incoming=(assetType:string)=>new Request('https://local/api/market-insights',{method:'POST',body:JSON.stringify({requests:[{marketRef:{provider:'coingecko',kind:'rwa',id:'gold',assetType},currency:'USD'}]})});
