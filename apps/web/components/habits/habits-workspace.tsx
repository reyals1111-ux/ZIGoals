...
export function HabitsWorkspace() {
  ...
  return <div className="habits-workspace">
    ...
    {!store.loaded ? <p role="status">Loading your private habits…</p> : <>
      ...
      <p className="fine habit-semantics">Streaks count scheduled successful days or completed target periods. Non-scheduled and paused dates do not count against consistency. Skips and failures remain distinct. The optional timer runs only while this page is open; browser-closed reminders are not promised.</p>
    </>}
  </div>;
}
