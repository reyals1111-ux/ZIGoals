...
export function PlatformNav(){return <nav className="tab-row view-tabs platform-nav" aria-label="Goal workspace"><Link href="/app/goals">All goals</Link><Link href="/app/goals/tracked">Tracked goals</Link><Link href="/app/goals/positions">Your ZIG / Positions</Link></nav>;}
