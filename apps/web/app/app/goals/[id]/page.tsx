...
export default function GoalDetail({
 ...
 <GoalModule id="contribution-plan" title="Contribution plan" description={plan?`${displayAmount(plan.monthlyContribution,plan.currency)} monthly`:'Recover your plan'}>{result&&<><h2>Funding health · 0% future return</h2><p>{result.fundingHealthExplanation}</p><p>Contributions remaining: {result.contributionPeriodsRemaining}</p><p>Required contribution: {displayAmount(result.fundingRequiredContribution,summary.currency)}</p></>}{plan&&(        <div className="scenario-panel">
          <div>
