...
B pending: obtain named browser failures in isolated production mode. C pending: repair at most three proven small cause groups. Next command: inspect Playwright reporter support, then add and verify a run-owned diagnostic command.
