...
- [Local verification](LOCAL_VERIFICATION.json):559JS,25Rust,46production browser,14workerd, full Chrome restart, build/dryrun/format/types/Clippy/schema/secret results and independent review. CI recorded separately once PR runs finish.
- [Owner CPU checklist](../../deployment/CPU_OWNER_CHECKLIST.md): exact-version post-deployment comparison, direct tail sanitization and strict missing-evidence handling.
- [Resume state](RESUME_STATE.md): next work and checkpoint instructions. [Run report](../../RUN_6_REPORT.md) consolidates all deliverables.
