...
Live read-only evidence on 2026-09-13: zig-test-2 reports v5.0.0-patch-1, staking azig and bank metadata exponent 18. Official version.txt still says v4.1.0. Pin testnet config to live evidence, validate chain ID and denom before signing, and refuse mainnet outright in this build. Public SDK package investigation continues before selecting a wallet integration.
