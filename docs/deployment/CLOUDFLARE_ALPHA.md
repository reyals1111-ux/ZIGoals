...
Final local acceptance on clean790a50d:476 JS,36 Next browser,8 workerd cases plus full Chrome restart; dry-run9361.17 KiB raw/1753.57 KiB gzip,32 assets. Canonical `/app` metadata uses the served origin, never a private goal ID/query. These observations still grant no publication claim.
